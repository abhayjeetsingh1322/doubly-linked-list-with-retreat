...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node currLastLeft = this.lastLeft;
        newNode.next = currLastLeft.next;

        newNode.next.previous = newNode;
        currLastLeft.next = newNode;

        newNode.previous = currLastLeft;
    ...
    public final T removeRightFront() {
        ...
        // Taking node data
        Node rightF = this.lastLeft.next;
        T val = rightF.data;

        // Removing the node link
        rightF.next.previous = this.lastLeft;
        this.lastLeft.next = rightF.next;
