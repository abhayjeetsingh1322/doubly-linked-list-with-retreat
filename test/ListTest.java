...
public abstract class ListTest {
    ...
    /**
     * Global variable used throughout testing used to avoid check style errors.
     */
    ...
    /**
     * CORRECTION: ADDED TEST CASE (0.5 POINTS).
     */
    @Test
    public final void testRetreatLeftMultipleRightEmpty() {
        ...
        List<String> list2 = this.createFromArgsRef(1, "red", "blue");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    public final void testRetreatLeftNonEmptyRightOne() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(FOUR, "yellow", "orange",
                "purple", "red");
        List<String> list2 = this.createFromArgsRef(THREE, "yellow", "orange",
                "purple", "red");
        /*
